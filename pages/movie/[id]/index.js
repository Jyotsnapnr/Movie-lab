...
function Movie( {movie }) {
  return (
    ...
    <Image src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} width={800} height={500} className="rounded-md" alt="img" />
<h1 className="font-bold text-xl my-2">{movie.title}</h1>4
